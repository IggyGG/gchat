...
export type Response = { "kind": "network_status", status: NetworkStatus, } | { "kind": "instance", instance: InstanceInfo, } | { "kind": "snapshot", snapshot: Snapshot, } | { "kind": "history", page: HistoryPage, } | { "kind": "completed", items: Array<Completion>, } | { "kind": "catalogue", commands: Array<CommandSpec>, } | { "kind": "projection", conversations: Array<Conversation>, revision: string, } | { "kind": "output", conversation: string | null, output: CommandOutput, } | { "kind": "applied", conversation: string | null, notice: string | null, } | { "kind": "changed", revision: string, } | { "kind": "error", code: string, message: string, };
